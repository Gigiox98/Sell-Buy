			...
			<form action="Vendi" method="post" enctype="multipart/form-data">
				<div class="container">
					...
					<div class="row">
						...
						<br><br>
						<label class="col-sm-2" for="quantità">Quantità:</label> <input class="col-sm-4" type="number" class="form-control" name="quantità">
						<br><br>
						<label class="col-sm-2" for="località">Località:</label> <input  class="col-sm-4" type="text" class="form-control" name="località">
						<br><br>
