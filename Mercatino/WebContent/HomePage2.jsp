		...
		<div class=" text-left">
			<nav class="navbar navbar-inverse" style="margin: 0%;">
				...
				<div class="collapse navbar-collapse" id="myNavbar"
					...
					<span class="navbar-brand " style="color: rgb(242, 238, 0);">Filtro Ricerca</span> 
					<input type="text" class="my_input" placeholder="Prodotto">
					...
					%>
						...
						<li>
      					<a href="Carrello.jsp" style="color: rgb(242, 238, 0);" class="glyphicon glyphicon-shopping-cart">
						</a>
						</li>
			...
			x = p.doRetriveByCond("stato='Nuovo'");
				...
				<div class="col-sm-4">
					<div class="panel panel-primary">
						...
						<form action="dettagli" method="post">
								<input type="hidden" name="code" value="<%=y.getCodice()%>">
								<input type="submit" class="btn btn-primary btn-md" value="Dettagli Prodotto">
						</form>
						</div>
					</div>
				</div>
